...
namespace margelo::nitro::okhinitro {
  ...
  /**
   * A struct which can be represented as a JavaScript object (OkHiException).
   */
  struct OkHiException {
  public:
    std::string code     SWIFT_PRIVATE;
    std::string message     SWIFT_PRIVATE;

  public:
    OkHiException() = default;
    explicit OkHiException(std::string code, std::string message): code(code), message(message) {}
  };
...
namespace margelo::nitro {
  ...
  // C++ OkHiException <> JS OkHiException (object)
  template <>
  struct JSIConverter<margelo::nitro::okhinitro::OkHiException> final {
    static inline margelo::nitro::okhinitro::OkHiException fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::okhinitro::OkHiException(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::okhinitro::OkHiException& arg) {
